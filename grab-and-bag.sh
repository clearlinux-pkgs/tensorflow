...
if [ ! -e v1.1.0.tar.gz ]; then
	curl -O -L https://github.com/tensorflow/tensorflow/archive/v1.1.0.tar.gz
fi	
rm -rf tensorflow-1.1.0
rm -rf tmp
mkdir tmp

tar -axf v1.1.0.tar.gz

pushd tensorflow-1.1.0
	...
	mv ../tmp/tensorflow-1.1.0-cp36-cp36m-linux_x86_64.whl  ../tmp/tensorflow-1.1.0-cp36-cp36m-linux_x86_64.whlgeneric
	...
	bazel-bin/tensorflow/tools/pip_package/build_pip_package $PWD/../tmp/
	mv ../tmp/tensorflow-1.1.0-cp36-cp36m-linux_x86_64.whl  ../tmp/tensorflow-1.1.0-cp36-cp36m-linux_x86_64.whlavx2
	...
	bazel-bin/tensorflow/tools/pip_package/build_pip_package $PWD/../tmp/
	mv ../tmp/tensorflow-1.1.0-cp36-cp36m-linux_x86_64.whl  ../tmp/tensorflow-1.1.0-cp36-cp36m-linux_x86_64.whlavx512
popd
