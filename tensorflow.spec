...
#Source15 : http://localhost/tensorflow/tensorflow-1.3.0-cp36-cp36m-linux_x86_64.whlavx512
Source20 : http://localhost/tensorflow/tensorflow-1.3.0-cp36-cp36m-linux_x86_64.whlgeneric
...
mv %{SOURCE10} tensorflow-1.3.0-cp36-cp36m-linux_x86_64.whl

pip3 install --no-deps  --root %{buildroot} tensorflow-1.3.0-cp36-cp36m-linux_x86_64.whl
for i in `find %{buildroot} -name "*.so" `; do mv $i $i.avx2 ; done

#mv %{SOURCE15} tensorflow-1.3.0-cp36-cp36m-linux_x86_64.whl
#
#pip3 install --no-deps  --root %{buildroot} tensorflow-1.3.0-cp36-cp36m-linux_x86_64.whl
#for i in `find %{buildroot} -name "*.so" `; do mv $i $i.avx512 ; done

mv %{SOURCE20} tensorflow-1.3.0-cp36-cp36m-linux_x86_64.whl

pip3 install --no-deps --force-reinstall  --root %{buildroot} tensorflow-1.3.0-cp36-cp36m-linux_x86_64.whl
